...
// using Microsoft.EntityFrameworkCore;
// using BCrypt.Net; 
// using Microsoft.AspNetCore.Authentication.JwtBearer; // <-- Importante para soportar tokens JWT

// namespace Concesionario.Controllers
// {
//     [Route("Admin")]
//     // Forzamos a que todo el controlador entienda tanto la Cookie clásica de Identity como tus JWT Bearer Tokens
...
//         // API unificada para listar vehículos (Protegida)
//         // Soporta llamadas directas sin parámetros o llamadas paginadas con filtros
//         [HttpGet("GetVehiculos")]
...
//                 // Si la petición desde JS no envía el parámetro de página, devolvemos la lista completa plana
//                 if (pagina == null)
//                 {
...
//                 // Si la petición viene con número de página, aplicamos segmentación y devolvemos la estructura { items, total }
//                 var total = await query.CountAsync();
//                 var items = await query
//                     .OrderByDescending(v => v.Id)
...
using Microsoft.EntityFrameworkCore;
using BCrypt.Net; 
using Microsoft.AspNetCore.Authentication.JwtBearer; // <-- Soportar tokens JWT

namespace Concesionario.Controllers
{
    [Route("Admin")]
    // Configuración corregida: Solo utiliza el esquema Bearer configurado en tu Program.cs
