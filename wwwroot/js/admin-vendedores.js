...
//                 <td class="align-middle text-info fw-bold">${v.porcentajeComision || v.comision}%</td>
...
//     // 3. Comerciales
//     document.getElementById('vendedor-comision').value = v.porcentajeComision !== undefined ? v.porcentajeComision : v.comision;
...
//         // Mapeo de propiedades personales y de ubicación georeferenciada
...
//         // 🛠️ CORRECCIÓN AQUÍ: Se cambiaron las claves para emparejar con el backend en C#
